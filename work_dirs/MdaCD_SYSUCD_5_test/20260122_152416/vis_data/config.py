...
launcher = 'pytorch'
load_from = '/home/dell/gitrepos/MdaCD/work_dirs/MdaCD_SYSUCD_5/best_mIoU_iter_11000.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ...
    keep_results=True,
    output_dir='/home/dell/gitrepos/MdaCD/work_dirs/MdaCD_SYSUCD_5/test_result',
    type='IoUMetric')
test_pipeline = [
    dict(type='LoadMultipleRSImageFromFile'),
    dict(type='LoadAnnotations'),

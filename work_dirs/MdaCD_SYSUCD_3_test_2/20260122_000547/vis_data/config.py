...
launcher = 'pytorch'
load_from = '/home/dell/gitrepos/MdaCD/work_dirs/MdaCD_SYSUCD_3/best_mIoU_iter_10000.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ...
    keep_results=True,
    output_dir='/home/dell/gitrepos/MdaCD/work_dirs/MdaCD_SYSUCD_3/test_result',
    type='IoUMetric')
test_pipeline = [
    dict(type='LoadMultipleRSImageFromFile'),
    dict(type='LoadAnnotations'),

...
def dir_metric(pred_path, gt_path, pred_suffix, gt_suffix, n_class):
    ...
    paper_metrics = [round(float(value) * 100, 2) if np.ndim(value) == 0 else [round(float(v) * 100, 2) for v in value] for value in paper_metrics]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--gggt', type=str, default='/home/dell/gitrepos/MdaCD/Dataset/LEVIRCD/test/label')
